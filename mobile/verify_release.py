...
r=b.ROOT.parent
apks=[r/'release'/('AI练习室-v'+v+'.apk') for v in ['1.0.5','1.0.6']]
certs=[]
for apk in apks:
...
print('PASS: v1.0.5 and v1.0.6 signing certificates match; bundled page equals verified page; original question data unchanged.')
