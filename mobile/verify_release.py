...
r=b.ROOT.parent
apks=[r/'release'/('AI练习室-v'+v+'.apk') for v in ['1.0.8','1.0.9']]
certs=[]
for apk in apks:
...
print('PASS: v1.0.8 and v1.0.9 signing certificates match; bundled page equals verified page; original question data unchanged.')
